...
```
[Untested] Ghosts - courtesy of @matyeus

```
~Lv2~{"Name":"Ghosts","Group":"A.M.R. Shisio","ZoneLockH":[1155,1156],"ElementsL":[{"Name":"Ghosts & Spread","type":1,"radius":16.0,"color":536871167,"refActorComparisonType":7,"Filled":true,"refActorVFXPath":"vfx/lockon/eff/lockon15_t0a1.avfx","refActorVFXMin":5996,"refActorVFXMax":14986}]}
```

Boss 2 - Gorai
---------------------
Waymarks for Jumps (requires waymark plugin)
```
